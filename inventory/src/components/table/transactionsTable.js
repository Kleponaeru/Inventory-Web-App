...
const TableTransactions = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("http://localhost:5000/api/transactions"); // Adjust the URL to your actual API endpoint
      ...
      <div className="p-4">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-lg font-semibold">Transactions List</h1>
            <input
              type="text"
              placeholder="Search"
              value={searchText}
